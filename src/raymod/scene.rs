...
impl Scene {
    ...
    pub fn random_scene(& mut self,w:usize,h:usize)->Camera{
        self.model_name = String::from("Random Scene");
    ...
    pub fn model_init3(&mut self) {
        ...
        self.add(Box::new(Sphere::new(2.5e3,Vec3::new(0.82,0.92,-2.0)*1e4,
                                      Arc::new(Diffuse::new(Vec3::new(1.0,1.0,1.0)*0.8e2,BLACK)), ))); // moon
        self.add(Box::new(Sphere::new(2.5e4,Vec3::new(50.0, 0.0, 0.0),
                                      Arc::new(Diffuse::new(Vec3::new(0.114, 0.133, 0.212)*1e-2,
                                                            Vec3::new(0.216,0.384,1.0)*0.003)),))); // sky
        self.add(Box::new(Sphere::new(5e0,  Vec3::new(-0.2,0.16,-1.0)*1e4,
                                      Arc::new(Diffuse::new(Vec3::new(1.00, 0.843, 0.698)*1e2,BLACK)),)));  // star
        self.add(Box::new(Sphere::new(5e0,  Vec3::new(0.0,0.18,-1.0)*1e4,
                                      Arc::new(Diffuse::new(Vec3::new(1.00, 0.851, 0.710)*1e2,BLACK)), )));  // star
        self.add(Box::new(Sphere::new(5e0,  Vec3::new(0.3,0.15,-1.0)*1e4,
                                      Arc::new(Diffuse::new(Vec3::new(0.671, 0.780, 1.00)*1e2,BLACK)),)));  // star
        self.add(Box::new(Sphere::new(3.5e4,Vec3::new(600.0,-3.5e4+1.0,300.0),
                                      Arc::new(Refract::new(BLACK,Vec3::new(0.6,0.8,1.0)*0.01)),)));   //pool
        self.add(Box::new(Sphere::new(5e4,  Vec3::new(-500.0,-5e4  ,0.0),
                                      Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.35)),)));    //hill
        self.add(Box::new(Sphere::new(16.5, Vec3::new(27.0,0.0,47.0),
                                      Arc::new(Diffuse::new(BLACK, Vec3::new(1.0,1.0,1.0)*0.33)),))); //hut
        self.add(Box::new(Sphere::new(7.0,  Vec3::new(27.0+8.0*SQRT_2,0.0,47.0+8.0*SQRT_2),
                                      Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.33)),))); //door
        self.add(Box::new(Sphere::new(500.0,Vec3::new(-1e3,-300.0,-3e3),
                                      Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.351)),)));  //mnt
        self.add(Box::new(Sphere::new(830.0,Vec3::new(0.0,-500.0,-3e3),
                                      Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.354)),)));  //mnt
        self.add(Box::new(Sphere::new(490.0,Vec3::new(1e3,-300.0,-3e3),
    ...
    pub fn model_init5(&mut self) {
        ...
        self.add(Box::new( Sphere::new(8000.0, cen+Vec3::new(0.0,-8000.0,-900.0),
                                       Arc::new(Diffuse::new(Vec3::new(1.0,0.4,0.1)*5e-1,BLACK)), ))); // sun
        self.add(Box::new( Sphere::new(1e4,    cen+Vec3::zero(),
                                       Arc::new(Diffuse::new(Vec3::new(0.631, 0.753, 1.00)*3e-1,
                                                             Vec3::new(1.0,1.0,1.0)*0.5)),))); // sky

        self.add(Box::new( Sphere::new(150.0,  cen+Vec3::new(-350.0, 0.0,-100.0),
                                       Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.3)),))); // mnt
        self.add(Box::new( Sphere::new(200.0,  cen+Vec3::new(-210.0, 0.0,-100.0),
                                       Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.3)),))); // mnt
        self.add(Box::new( Sphere::new(145.0,  cen+Vec3::new(-210.0,85.0,-100.0),
                                       Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.8)),))); // snow
        self.add(Box::new( Sphere::new(150.0,  cen+Vec3::new(-50.0,  0.0,-100.0),
                                       Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.3)),))); // mnt
        self.add(Box::new( Sphere::new(150.0,  cen+Vec3::new(100.0,  0.0,-100.0),
                                       Arc::new(Diffuse::new(BLACK, Vec3::new(1.0,1.0,1.0)*0.3)),))); // mnt
        self.add(Box::new( Sphere::new(125.0,  cen+Vec3::new(250.0,  0.0,-100.0),
                                       Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.3)),))); // mnt
        self.add(Box::new( Sphere::new(150.0,  cen+Vec3::new(375.0,  0.0,-100.0),
                                       Arc::new(Diffuse::new(BLACK, Vec3::new(1.0,1.0,1.0)*0.3)),))); // mnt
        self.add(Box::new( Sphere::new(2500.0, cen+Vec3::new(0.0,-2400.0,-500.0),
                                       Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.1)),))); // mnt base

        self.add(Box::new( Sphere::new(8000.0, cen+Vec3::new(0.0,-8000.0, 200.0),
                                       Arc::new(Refract::new(BLACK,Vec3::new(0.2,0.2,1.0))),))); // water
        self.add(Box::new( Sphere::new(8000.0, cen+Vec3::new(0.0,-8000.0,1100.0),
                                       Arc::new(Diffuse::new(BLACK,Vec3::new(0.0,0.3,0.0) )),))); // grass
        self.add(Box::new( Sphere::new(8.0   , cen+Vec3::new(-75.0, -5.0, 850.0),
                                       Arc::new(Diffuse::new(BLACK,Vec3::new(0.0,0.3,0.0) )),))); // bush
        self.add(Box::new( Sphere::new(30.0,   cen+Vec3::new(0.0,   23.0, 825.0),
                                       Arc::new(Refract::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.996)),))); // ball

        self.add(Box::new( Sphere::new(30.0,   cen+Vec3::new(200.0,280.0,-400.0),
                                       Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.8)),)));   // clouds
        self.add(Box::new( Sphere::new(37.0,   cen+Vec3::new(237.0,280.0,-400.0),
                                       Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.8)),)));   // clouds
        self.add(Box::new( Sphere::new(28.0,   cen+Vec3::new(267.0,280.0,-400.0),
                                       Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.8)),)));   // clouds

        self.add(Box::new( Sphere::new(40.0,   cen+Vec3::new(150.0,280.0,-1000.0),
                                       Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.8)),)));  // clouds
        self.add(Box::new( Sphere::new(37.0,   cen+Vec3::new(187.0,280.0,-1000.0),
                                       Arc::new(Diffuse::new(BLACK, Vec3::new(1.0,1.0,1.0)*0.8)),)));  // clouds

        self.add(Box::new( Sphere::new(40.0,   cen+Vec3::new(600.0,280.0,-1100.0),
                                       Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.8)), )));  // clouds
        self.add(Box::new( Sphere::new(37.0,   cen+Vec3::new(637.0,280.0,-1100.0),
                                       Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.8)),)));  // clouds
        self.add(Box::new( Sphere::new(37.0, cen+Vec3::new(-800.0,280.0,-1400.0),
                                       Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.8)),))); // clouds
        self.add(Box::new( Sphere::new(37.0, cen+Vec3::new(0.0,   280.0,-1600.0),
                                       Arc::new(Diffuse::new(BLACK, Vec3::new(1.0,1.0,1.0)*0.8)),)));    // clouds
        self.add(Box::new( Sphere::new(37.0, cen+Vec3::new(537.0, 280.0,-1800.0),
                                       Arc::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.8)),  )));  // clouds
    }
    pub fn model_init6(&mut self) {
        //----------------Overlap  sc6-----------------
        self.model_name=String::from("Overlap");
        self.add(Box::new( Sphere::new(150.0, Vec3::new(50.0+75.0,28.0,62.0),
                                       Arc::new(Refract::new(Vec3::new(1.0,1.0,1.0)*0e-3,
                                                             Vec3::new(1.0,0.9,0.8)*0.93)), )));
        self.add(Box::new( Sphere::new(28.0,  Vec3::new(50.0+5.0,-28.0,62.0), 
                                       Arc::new(Diffuse::new(Vec3::new(1.0,1.0,1.0)*1e1, BLACK)),)));
        self.add(Box::new( Sphere::new(300.0, Vec3::new(50.0,     28.0,62.0), 
    ...
    pub fn model_init9(&mut self) {
        ...
        self.add(Box::new( Sphere::new(4.0, Vec3::new(50.0,6.0*0.6,47.0),
                              Arc::new(Diffuse::new(BLACK, Vec3::new(0.13,0.066,0.033) )),)));//"tree"
        self.add(Box::new( Sphere::new(16.0,Vec3::new(50.0,6.0*2.0+16.0*0.6,47.0),
                              Arc::new(Diffuse::new(BLACK, tc)),  )));//"tree"
        self.add(Box::new( Sphere::new(11.0,Vec3::new(50.0,6.0*2.0+16.0*0.6*2.0+11.0*0.6,47.0),
                              Arc::new(Diffuse::new(BLACK, tc)),  )));//"tree"
        self.add(Box::new( Sphere::new(7.0 ,Vec3::new(50.0,6.0*2.0+16.0*0.6*2.0+11.0*0.6*2.0+7.0*0.6,47.0),
                              Arc::new(Diffuse::new(BLACK, tc)), )));//"tree"

        self.add(Box::new( Sphere::new(15.5,Vec3::new(50.0,1.8+6.0*2.0+16.0*0.6,47.0),
                              Arc::new(Diffuse::new(BLACK, scc)),)));//"tree"
        self.add(Box::new( Sphere::new(10.5,Vec3::new(50.0,1.8+6.0*2.0+16.0*0.6*2.0+11.0*0.6,47.0),
                              Arc::new(Diffuse::new(  BLACK, scc)), )));//"tree"
        self.add(Box::new( Sphere::new(6.5, Vec3::new(50.0,1.8+6.0*2.0+16.0*0.6*2.0+11.0*0.6*2.0+7.0*0.6,47.0),
                              Arc::new(Diffuse::new(  BLACK, scc)),  )));//"tree"
    }
}
...
pub fn model_init1(&mut self)->bool{
        //----------cornel box sc1-----------
        self.add(Box::new( Sphere::new( 1e5,   Vec3::new(1e5 + 1.0,      40.8, 81.6),BLACK,                 Vec3::new(0.75, 0.25, 0.25), Refl::Diff ));
        self.add(Box::new( Sphere::new( 1e5,   Vec3::new(-1e5 + 99.0,    40.8, 81.6),BLACK,                 Vec3::new(0.25, 0.25, 0.75), Refl::Diff ));
        self.add(Box::new( Sphere::new( 1e5,   Vec3::new(50.0,           40.8, 1e5 ),BLACK,                 Vec3::new(0.75, 0.75, 0.75), Refl::Diff ));
        self.add(Box::new( Sphere::new( 1e5,   Vec3::new(50.0,           40.8,-1e5 + 170.0),BLACK,         BLACK, Refl::Diff ));
        self.add(Box::new( Sphere::new( 1e5,   Vec3::new(50.0,            1e5, 81.6),BLACK,                 Vec3::new(0.75, 0.75, 0.75), Refl::Diff ));
        self.add(Box::new( Sphere::new( 1e5,   Vec3::new(50.0,-1e5 + 81.6+4.0, 81.6),BLACK,                 Vec3::new(0.75, 0.75, 0.75), Refl::Diff ));
        self.add(Box::new( Sphere::new( 16.5,  Vec3::new(27.0,           16.5, 47.0),BLACK,                 Vec3::new(1.0, 1.0, 1.0) * 0.999, Refl::Spec ));
        self.add(Box::new( Sphere::new( 16.5,  Vec3::new(73.0,           16.5, 78.0),BLACK,                 Vec3::new(1.0, 1.0, 1.0) * 0.999, Refl::Refr ));
        self.add(Box::new( Sphere::new( 1.5,   Vec3::new(50.0,      81.6-16.5, 81.6), Vec3::new(4.0,4.0,4.0)*100.0,BLACK, Refl::Diff ));
    true
    }
