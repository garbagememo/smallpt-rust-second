...
impl Scene {
    ...
    pub fn model_init0(&mut self) -> bool {
        ...
        self.add(Sphere::new(
            ...
            Box::new(Diffuse::new(BLACK,Vec3::new(0.75, 0.25, 0.25))),
        )); //left
        self.add(Sphere::new(
            1e5,
            Vec3::new(-1e5 + 99.0, 40.8, 81.6),
            Box::new(Diffuse::new(BLACK,Vec3::new(0.25, 0.25, 0.75))),
        )); //right
        self.add(Sphere::new(
            1e5,
            Vec3::new(50.0, 40.8, 1e5),
            Box::new(Diffuse::new(BLACK,Vec3::new(0.75, 0.75, 0.75))),
        )); //front
        self.add(Sphere::new(
            1e5,
            Vec3::new(50.0, 40.8, -1e5 + 170.0),
            Box::new(Diffuse::new(BLACK,BLACK)),
        )); //back
        self.add(Sphere::new(
            1e5,
        ...
        self.add(Sphere::new(
            ...
            Box::new(Mirror::new(BLACK,Vec3::new(1.0, 1.0, 1.0) * 0.999)),
        )); //mirror
        self.add(Sphere::new(
            16.5,
            Vec3::new(73.0, 16.5, 78.0),
            Box::new(Refract::new(BLACK,Vec3::new(1.0, 1.0, 1.0) * 0.999)),
        )); //透明体
        self.add(Sphere::new(
            600.0,
            Vec3::new(50.0, 681.6 - 0.27 + 4.0, 81.6),
            Box::new(Diffuse::new(Vec3::new(12.0, 12.0, 12.0), BLACK)),
        )); //light
        true
    }
    ...
    pub fn model_init2(&mut self) -> bool {
        ...
        self.add(Sphere::new(
            ...
            Box::new(Diffuse::new(BLACK,Vec3::new(0.3, 0.3, 0.3))),
        )); // grnd
        self.add(Sphere::new(
            110000.0,
            Vec3::new(50.0, -110048.5, 0.0),
            Box::new(Diffuse::new(Vec3::new(0.9, 0.5, 0.05) * 4.0, BLACK)),
        )); // horizon brightener
        self.add(Sphere::new(
            4e4,
            Vec3::new(50.0, -4e4 - 30.0, -3000.0),
            Box::new(Diffuse::new(BLACK,Vec3::new(0.2, 0.2, 0.2))),
        )); // mountains

        self.add(Sphere::new(
            26.5,
            Vec3::new(22.0, 26.5, 42.0),
            Box::new(Mirror::new(BLACK,Vec3::new(1.0, 1.0, 1.0) * 0.596)),
        )); // white Mirr
        self.add(Sphere::new(
            13.0,
            Vec3::new(75.0, 13.0, 82.0),
            Box::new(Refract::new(BLACK,Vec3::new(0.96, 0.96, 0.96) * 0.96)),
        )); // Glas
        self.add(Sphere::new(
            22.0,
            Vec3::new(87.0, 22.0, 24.0),
            Box::new(Refract::new(BLACK,Vec3::new(0.6, 0.6, 0.6) * 0.696)),
        )); // Glas2
        true
    }
    pub fn model_init3(&mut self)->bool{
        ...
        self.add(Sphere::new(2.5e3,Vec3::new(0.82,0.92,-2.0)*1e4,
                             Box::new(Diffuse::new(Vec3::new(1.0,1.0,1.0)*0.8e2,BLACK)), )); // moon
        self.add(Sphere::new(2.5e4,Vec3::new(50.0, 0.0, 0.0),
                             Box::new(Diffuse::new(Vec3::new(0.114, 0.133, 0.212)*1e-2,
                                                   Vec3::new(0.216,0.384,1.0)*0.003)),)); // sky
        self.add(Sphere::new(5e0,  Vec3::new(-0.2,0.16,-1.0)*1e4,
                             Box::new(Diffuse::new(Vec3::new(1.00, 0.843, 0.698)*1e2,BLACK)),));  // star
        self.add(Sphere::new(5e0,  Vec3::new(0.0,0.18,-1.0)*1e4,
                             Box::new(Diffuse::new(Vec3::new(1.00, 0.851, 0.710)*1e2,BLACK)), ));  // star
        self.add(Sphere::new(5e0,  Vec3::new(0.3,0.15,-1.0)*1e4,
                             Box::new(Diffuse::new(Vec3::new(0.671, 0.780, 1.00)*1e2,BLACK)),));  // star
        self.add(Sphere::new(3.5e4,Vec3::new(600.0,-3.5e4+1.0,300.0),
                             Box::new(Refract::new(BLACK,Vec3::new(0.6,0.8,1.0)*0.01)),));   //pool
        self.add(Sphere::new(5e4,  Vec3::new(-500.0,-5e4  ,0.0),
                             Box::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.35)),));    //hill
        self.add(Sphere::new(16.5, Vec3::new(27.0,0.0,47.0),
                             Box::new(Diffuse::new(BLACK, Vec3::new(1.0,1.0,1.0)*0.33)),)); //hut
        self.add(Sphere::new(7.0,  Vec3::new(27.0+8.0*SQRT_2,0.0,47.0+8.0*SQRT_2),
                             Box::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.33)),)); //door
        self.add(Sphere::new(500.0,Vec3::new(-1e3,-300.0,-3e3),
                             Box::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.351)),));  //mnt
        self.add(Sphere::new(830.0,Vec3::new(0.0,-500.0,-3e3),
                             Box::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.354)),));  //mnt
        self.add(Sphere::new(490.0,Vec3::new(1e3,-300.0,-3e3),
                             Box::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.352)),));  //mnt 
         true
	 }
    ...
    pub fn model_init4(&mut self) -> bool {
        ...
        self.add(Sphere::new(
            ...
            Box::new(Diffuse::new(Vec3::new(1.0, 1.0, 1.0) * 2e2, BLACK)),
        )); // sun
        self.add(Sphere::new(
            800.0,
            cen + Vec3::new(0.0, -880.0, -9120.0),
            Box::new(Diffuse::new(Vec3::new(1.0, 1.0, 1.0) * 2e1, BLACK)),
        )); // horizon
        self.add(Sphere::new(
            10000.0,
        ...
        self.add(Sphere::new(
            ...
            Box::new(Refract::new(BLACK,Vec3::new(0.110, 0.898, 1.00) * 0.996)),
        )); // water
        self.add(Sphere::new(
            790.0,
            cen + Vec3::new(0.0, -720.0, -200.0),
            Box::new(Diffuse::new(BLACK,Vec3::new(0.4, 0.3, 0.04) * 0.6)),
        )); // earth
        self.add(Sphere::new(
            325.0,
            cen + Vec3::new(0.0, -255.0, -50.0),
            Box::new(Diffuse::new(BLACK,Vec3::new(0.4, 0.3, 0.04) * 0.8)),
        )); // island
        self.add(Sphere::new(
            275.0,
            cen + Vec3::new(0.0, -205.0, -33.0),
            Box::new(Diffuse::new(BLACK,Vec3::new(0.02, 0.3, 0.02) * 0.75)),
        )); // grass
        true
    }
    ...
    pub fn model_init5(&mut self)->bool{
        ...
        self.add( Sphere::new(2500.0, cen+Vec3::new(0.0,-2400.0,-500.0),
                              Box::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.1)),)); // mnt base

        self.add( Sphere::new(8000.0, cen+Vec3::new(0.0,-8000.0, 200.0),
                              Box::new(Refract::new(BLACK,Vec3::new(0.2,0.2,1.0))),)); // water
        self.add( Sphere::new(8000.0, cen+Vec3::new(0.0,-8000.0,1100.0),
                              Box::new(Diffuse::new(BLACK,Vec3::new(0.0,0.3,0.0) )),)); // grass
        self.add( Sphere::new(8.0   , cen+Vec3::new(-75.0, -5.0, 850.0),
                              Box::new(Diffuse::new(BLACK,Vec3::new(0.0,0.3,0.0) )),)); // bush
        self.add( Sphere::new(30.0,   cen+Vec3::new(0.0,   23.0, 825.0),
                              Box::new(Refract::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.996)),)); // ball

        self.add( Sphere::new(30.0,   cen+Vec3::new(200.0,280.0,-400.0),
                              Box::new(Diffuse::new(BLACK,Vec3::new(1.0,1.0,1.0)*0.8)),));   // clouds
    ...
    pub fn model_init7(&mut self) -> bool {
        ...
        self.add(Sphere::new(
            ...
            Box::new(Diffuse::new(Vec3::new(1.0, 1.0, 1.0) * 3e0, BLACK)),
        )); // sky
        self.add(Sphere::new(
            1e5,
            Vec3::new(50.0, -1e5 - d - r, 0.0),
            Box::new(Diffuse::new(BLACK,Vec3::new(0.1, 0.1, 0.1))),
        )); //grnd
        self.add(Sphere::new(
            r,
            Vec3::new(50.0, 40.8, 62.0) + Vec3::new(t.cos(), t.sin(), 0.0) * d,
            Box::new(Mirror::new(BLACK,Vec3::new(1.0, 0.3, 0.3) * 0.999)),
        )); //red
        self.add(Sphere::new(
            r,
            Vec3::new(50.0, 40.8, 62.0) + Vec3::new(-t.cos(), t.sin(), 0.0) * d,
            Box::new(Mirror::new(BLACK,Vec3::new(0.3, 1.0, 0.3) * 0.999)),
        )); //grn
        self.add(Sphere::new(
            r,
            Vec3::new(50.0, 40.8, 62.0) + Vec3::new(0.0, -1.0, 0.0) * d,
            Box::new(Mirror::new(BLACK,Vec3::new(0.3, 0.3, 1.0) * 0.999)),
        )); //blue
        self.add(Sphere::new(
            r,
            Vec3::new(50.0, 40.8, 62.0) + Vec3::new(0.0, 0.0, -1.0) * d,
            Box::new(Mirror::new(BLACK,Vec3::new(0.53, 0.53, 0.53) * 0.999)),
        )); //back
        self.add(Sphere::new(
            r,
            Vec3::new(50.0, 40.8, 62.0) + Vec3::new(0.0, 0.0, 1.0) * d,
    ...
    pub fn model_init8(&mut self)->bool{
        ...
        self.add( Sphere::new(
            ...
            Box::new(Mirror::new(c*6e-2, Vec3::new(1.0,1.0,1.0)*0.996)),)); //red
        self.add( Sphere::new(
            r, Vec3::new(50.0,28.0,z)+Vec3::new(-t.cos(),t.sin(),0.0)*d,
            Box::new(Mirror::new(c*6e-2, Vec3::new(1.0,1.0,1.0)*0.996)),)); //grn
        self.add( Sphere::new(
            r, Vec3::new(50.0,28.0,z)+Vec3::new(0.0,-1.0,0.0)*d,
            Box::new(Mirror::new(c*6e-2, Vec3::new(1.0,1.0,1.0)*0.996)),)); //blue
        self.add( Sphere::new(
            r,Vec3::new(50.0,28.0,z)+Vec3::new(0.0, 0.0,-1.0)*r*2.0*f64::sqrt(2.0/3.0),
            Box::new(Mirror::new(c*0e-2, Vec3::new(1.0,1.0,1.0)*0.996)),)); //back
        self.add( Sphere::new(
...
/*
    ...
    pub fn model_init6(&mut self)->bool{
        ...
        self.add( Sphere::new(28.0,  Vec3::new(50.0+5.0,-28.0,62.0), Vec3::new(1.0,1.0,1.0)*1e1, BLACK, Refl::Diff));
    ...
    pub fn model_init7(&mut self)->bool{
        ...
        self.add( Sphere::new(1e5, Vec3::new(50.0, 100.0, 0.0),      Vec3::new(1.0,1.0,1.0)*3e0,BLACK, Refl::Diff)); // sky
        self.add( Sphere::new(1e5, Vec3::new(50.0, -1e5-d-r, 0.0),  BLACK,               Vec3::new(0.1,0.1,0.1),Refl::Diff));           //grnd

        self.add( Sphere::new(r, Vec3::new(50.0,40.8,62.0)+Vec3::new( t.cos(),t.sin(),0.0)*d,BLACK, Vec3::new(1.0,0.3,0.3)*0.999, Refl::Spec)); //red
        self.add( Sphere::new(r, Vec3::new(50.0,40.8,62.0)+Vec3::new(-t.cos(),t.sin(),0.0)*d,BLACK, Vec3::new(0.3,1.0,0.3)*0.999, Refl::Spec)); //grn
        self.add( Sphere::new(r, Vec3::new(50.0,40.8,62.0)+Vec3::new(0.0,-1.0,0.0)*d,        BLACK, Vec3::new(0.3,0.3,1.0)*0.999, Refl::Spec)); //blue
        self.add( Sphere::new(r, Vec3::new(50.0,40.8,62.0)+Vec3::new(0.0, 0.0,-1.0)*d,    BLACK, Vec3::new(0.53,0.53,0.53)*0.999, Refl::Spec)); //back
        self.add( Sphere::new(r, Vec3::new(50.0,40.8,62.0)+Vec3::new(0.0, 0.0, 1.0)*d,       BLACK, Vec3::new(1.0,1.0,1.0)*0.999, Refl::Refr)); //front
        true
    }
    ...
    pub fn model_init9(&mut self)->bool{
        ...
        self.add( Sphere::new(1e2, Vec3::new(50.0, -1e2+2.0, 47.0), BLACK,              Vec3::new(1.0,1.0,1.0)*0.7,Refl::Diff)); //grnd
    ...
    self.add( Sphere::new(1e4,
        ...
        self.add( Sphere::new(4.0, Vec3::new(50.0,6.0*0.6,47.0),                             BLACK, Vec3::new(0.13,0.066,0.033), Refl::Diff));//"tree"
        self.add( Sphere::new(16.0,Vec3::new(50.0,6.0*2.0+16.0*0.6,47.0),                         BLACK, tc,  Refl::Diff));//"tree"
        self.add( Sphere::new(11.0,Vec3::new(50.0,6.0*2.0+16.0*0.6*2.0+11.0*0.6,47.0),            BLACK, tc,  Refl::Diff));//"tree"
        self.add( Sphere::new(7.0 ,Vec3::new(50.0,6.0*2.0+16.0*0.6*2.0+11.0*0.6*2.0+7.0*0.6,47.0),BLACK, tc,  Refl::Diff));//"tree"

        self.add( Sphere::new(15.5,Vec3::new(50.0,1.8+6.0*2.0+16.0*0.6,47.0),  BLACK, scc,  Refl::Diff));//"tree"
        self.add( Sphere::new(10.5,Vec3::new(50.0,1.8+6.0*2.0+16.0*0.6*2.0+11.0*0.6,47.0),  BLACK, scc,  Refl::Diff));//"tree"
        self.add( Sphere::new(6.5, Vec3::new(50.0,1.8+6.0*2.0+16.0*0.6*2.0+11.0*0.6*2.0+7.0*0.6,47.0),  BLACK, scc,  Refl::Diff));//"tree"
    true
    }
*/
